...
<div style="display: flex; gap: 10px;">
    <img src="./assets/screenshots/empty_state.png" alt="empty state" width="25%">
    <img src="./assets/screenshots/add_expense.png" alt="add expense" width="25%">
    <img src="./assets/screenshots/edit_expense.png" alt="edit expense" width="25%">
    <img src="./assets/screenshots/list_of_expenses.png" alt="list of all expenses" width="25%">
</div>>
